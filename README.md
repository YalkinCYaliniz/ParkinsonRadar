...
| ÖZELLİK           | ÖNCESİ     | SONRASI    | İYİLEŞME             |
|-------------------|------------|------------|-----------------------|
...
<img width="1692" height="498" alt="image" src="https://github.com/user-attachments/assets/ea4a0424-20fa-4dd3-9d7e-303af3798951" />
...
- **Daily Scrum :**  Toplantılar zoom + meet üzerinden gerçekleşmiştir.
